...
Program: a1_dkumar56.py 
Author: Dheeraj Kumar
The python code in this file (a1_dkumar56.py) is original work written by
"dkumar56". No code in this file is copied from any other source
...
def usage():    
    status='Usage: a1_dkumar56.py YYYYMMDD|YYYY/MM/DD|YYYY-MM-DD|YYYY.MM.DD'
    return status
